        ...
        <div className="w-full max-w-sm p-8 bg-white rounded-2xl shadow-sm border border-gray-100">
          ...
          <form onSubmit={handleMfaSubmit} className="space-y-4">
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-200 rounded-lg text-center text-2xl tracking-[0.5em] focus:ring-2 focus:ring-green-500 focus:border-transparent"
              placeholder="000000"
              maxLength={6}
              autoFocus
              required
